...
public class ExceptionLog {
	...
	/**
	 * If there are any logged exceptions, shows a small window with the logged
	 * exception in it. If there are none, dosen't do anything.
	 * 
	 * @param mainFrame
	 *            the frame to witch the dialog is attached
	 */
	public static void showException(Frame mainFrame) {
		...
		for (Iterator<Exception> iterator = exceptionLog.iterator(); iterator
				.hasNext();) {
